...
export interface CppManagementAnalyticsLinkReplaceResponse extends CppObservableResponse {
    status: string;
...
export interface CppManagementAnalyticsLinkReplaceAzureBlobExternalLinkRequest extends CppObservableRequest {
    link: CppManagementAnalyticsAzureBlobExternalLink;
    client_context_id?: string;
    timeout?: CppMilliseconds;
}
export interface CppManagementAnalyticsLinkReplaceCouchbaseRemoteLinkRequest extends CppObservableRequest {
    link: CppManagementAnalyticsCouchbaseRemoteLink;
    client_context_id?: string;
    timeout?: CppMilliseconds;
}
export interface CppManagementAnalyticsLinkReplaceS3ExternalLinkRequest extends CppObservableRequest {
    link: CppManagementAnalyticsS3ExternalLink;
    client_context_id?: string;
    timeout?: CppMilliseconds;
}
export interface CppManagementAnalyticsLinkDisconnectResponse extends CppObservableResponse {
    status: string;
...
export interface CppManagementAnalyticsLinkDisconnectRequest extends CppObservableRequest {
    dataverse_name: string;
    link_name: string;
    client_context_id?: string;
    timeout?: CppMilliseconds;
...
export interface CppManagementEventingGetStatusResponse extends CppObservableResponse {
    status: CppManagementEventingStatus;
    error?: CppManagementEventingProblem;
}
export interface CppManagementEventingGetStatusRequest extends CppObservableRequest {
    bucket_name?: string;
    scope_name?: string;
    client_context_id?: string;
    timeout?: CppMilliseconds;
}
export interface CppManagementEventingGetAllFunctionsResponse extends CppObservableResponse {
    functions: CppManagementEventingFunction[];
    error?: CppManagementEventingProblem;
}
export interface CppManagementEventingGetAllFunctionsRequest extends CppObservableRequest {
    bucket_name?: string;
    scope_name?: string;
    client_context_id?: string;
    timeout?: CppMilliseconds;
}
export interface CppManagementAnalyticsIndexCreateResponse extends CppObservableResponse {
    status: string;
    errors: CppManagementAnalyticsProblem[];
}
export interface CppManagementAnalyticsIndexCreateRequest extends CppObservableRequest {
    dataverse_name: string;
    dataset_name: string;
    index_name: string;
    fields: {
...
export interface CppManagementScopeGetAllResponse extends CppObservableResponse {
    manifest: CppTopologyCollectionsManifest;
}
...
export interface CppManagementSearchIndexDropResponse extends CppObservableResponse {
    status: string;
    error: string;
}
export interface CppManagementSearchIndexDropRequest extends CppObservableRequest {
    index_name: string;
    bucket_name?: string;
    scope_name?: string;
    client_context_id?: string;
...
export interface CppManagementSearchIndexControlPlanFreezeResponse extends CppObservableResponse {
    status: string;
    error: string;
}
export interface CppManagementSearchIndexControlPlanFreezeRequest extends CppObservableRequest {
    index_name: string;
    freeze: boolean;
    bucket_name?: string;
    scope_name?: string;
...
export interface CppManagementSearchGetStatsResponse extends CppObservableResponse {
    stats: string;
}
export interface CppManagementSearchGetStatsRequest extends CppObservableRequest {
    client_context_id?: string;
    timeout?: CppMilliseconds;
}
...
export interface CppManagementAnalyticsDataverseCreateResponse extends CppObservableResponse {
    status: string;
    errors: CppManagementAnalyticsProblem[];
}
export interface CppManagementAnalyticsDataverseCreateRequest extends CppObservableRequest {
    dataverse_name: string;
    ignore_if_exists: boolean;
    client_context_id?: string;
    timeout?: CppMilliseconds;
}
export interface CppManagementSearchIndexControlQueryResponse extends CppObservableResponse {
    status: string;
    error: string;
}
export interface CppManagementSearchIndexControlQueryRequest extends CppObservableRequest {
    index_name: string;
    allow: boolean;
    bucket_name?: string;
    scope_name?: string;
...
export interface CppManagementGroupGetAllResponse extends CppObservableResponse {
...
export interface CppManagementAnalyticsLinkCreateResponse extends CppObservableResponse {
    status: string;
...
export interface CppManagementAnalyticsLinkCreateAzureBlobExternalLinkRequest extends CppObservableRequest {
    link: CppManagementAnalyticsAzureBlobExternalLink;
    client_context_id?: string;
    timeout?: CppMilliseconds;
}
export interface CppManagementAnalyticsLinkCreateCouchbaseRemoteLinkRequest extends CppObservableRequest {
    link: CppManagementAnalyticsCouchbaseRemoteLink;
    client_context_id?: string;
    timeout?: CppMilliseconds;
}
export interface CppManagementAnalyticsLinkCreateS3ExternalLinkRequest extends CppObservableRequest {
    link: CppManagementAnalyticsS3ExternalLink;
    client_context_id?: string;
    timeout?: CppMilliseconds;
}
export interface CppManagementEventingDropFunctionResponse extends CppObservableResponse {
    error?: CppManagementEventingProblem;
}
export interface CppManagementEventingDropFunctionRequest extends CppObservableRequest {
    name: string;
    bucket_name?: string;
    scope_name?: string;
    client_context_id?: string;
...
export interface CppManagementCollectionDropResponse extends CppObservableResponse {
    uid: number;
}
export interface CppManagementCollectionDropRequest extends CppObservableRequest {
    bucket_name: string;
    scope_name: string;
    collection_name: string;
    client_context_id?: string;
...
export interface CppManagementSearchIndexControlIngestResponse extends CppObservableResponse {
    status: string;
    error: string;
}
export interface CppManagementSearchIndexControlIngestRequest extends CppObservableRequest {
    index_name: string;
    pause: boolean;
    bucket_name?: string;
    scope_name?: string;
...
export interface CppManagementEventingDeployFunctionResponse extends CppObservableResponse {
    error?: CppManagementEventingProblem;
}
export interface CppManagementEventingDeployFunctionRequest extends CppObservableRequest {
    name: string;
    bucket_name?: string;
    scope_name?: string;
    client_context_id?: string;
...
export interface CppManagementViewIndexGetResponse extends CppObservableResponse {
    document: CppManagementViewsDesignDocument;
}
...
export interface CppManagementBucketCreateResponse extends CppObservableResponse {
    error_message: string;
}
...
export interface CppManagementAnalyticsDatasetDropResponse extends CppObservableResponse {
    status: string;
    errors: CppManagementAnalyticsProblem[];
}
export interface CppManagementAnalyticsDatasetDropRequest extends CppObservableRequest {
    dataverse_name: string;
    dataset_name: string;
    ignore_if_does_not_exist: boolean;
    client_context_id?: string;
...
export interface CppManagementSearchIndexGetResponse extends CppObservableResponse {
    status: string;
    index: CppManagementSearchIndex;
    error: string;
}
export interface CppManagementSearchIndexGetRequest extends CppObservableRequest {
    index_name: string;
    bucket_name?: string;
    scope_name?: string;
    client_context_id?: string;
...
export interface CppManagementQueryIndexGetAllDeferredResponse extends CppObservableResponse {
    status: string;
    index_names: string[];
}
export interface CppManagementQueryIndexGetAllDeferredRequest extends CppObservableRequest {
    bucket_name: string;
    scope_name: string;
    collection_name: string;
    query_ctx: CppQueryContext;
...
export interface CppManagementQueryIndexBuildResponse extends CppObservableResponse {
    status: string;
...
export interface CppManagementQueryIndexBuildRequest extends CppObservableRequest {
    bucket_name: string;
    scope_name: string;
    collection_name: string;
    query_ctx: CppQueryContext;
...
export interface CppManagementEventingUndeployFunctionResponse extends CppObservableResponse {
    error?: CppManagementEventingProblem;
}
export interface CppManagementEventingUndeployFunctionRequest extends CppObservableRequest {
    name: string;
    bucket_name?: string;
    scope_name?: string;
    client_context_id?: string;
...
export interface CppManagementSearchIndexGetDocumentsCountResponse extends CppObservableResponse {
    status: string;
    count: number;
    error: string;
}
export interface CppManagementSearchIndexGetDocumentsCountRequest extends CppObservableRequest {
    index_name: string;
    bucket_name?: string;
    scope_name?: string;
    client_context_id?: string;
...
export interface CppManagementAnalyticsLinkGetAllResponse extends CppObservableResponse {
    status: string;
...
export interface CppManagementAnalyticsLinkGetAllRequest extends CppObservableRequest {
    link_type?: string;
    link_name?: string;
    dataverse_name?: string;
    client_context_id?: string;
...
export interface CppConnectionAutogen {
    ...
    managementAnalyticsLinkReplaceAzureBlobExternalLink(options: CppManagementAnalyticsLinkReplaceAzureBlobExternalLinkRequest, callback: (err: CppError | null, result: CppManagementAnalyticsLinkReplaceResponse) => void): void;
    managementAnalyticsLinkReplaceCouchbaseRemoteLink(options: CppManagementAnalyticsLinkReplaceCouchbaseRemoteLinkRequest, callback: (err: CppError | null, result: CppManagementAnalyticsLinkReplaceResponse) => void): void;
    managementAnalyticsLinkReplaceS3ExternalLink(options: CppManagementAnalyticsLinkReplaceS3ExternalLinkRequest, callback: (err: CppError | null, result: CppManagementAnalyticsLinkReplaceResponse) => void): void;
    ...
    managementAnalyticsLinkCreateAzureBlobExternalLink(options: CppManagementAnalyticsLinkCreateAzureBlobExternalLinkRequest, callback: (err: CppError | null, result: CppManagementAnalyticsLinkCreateResponse) => void): void;
    managementAnalyticsLinkCreateCouchbaseRemoteLink(options: CppManagementAnalyticsLinkCreateCouchbaseRemoteLinkRequest, callback: (err: CppError | null, result: CppManagementAnalyticsLinkCreateResponse) => void): void;
    managementAnalyticsLinkCreateS3ExternalLink(options: CppManagementAnalyticsLinkCreateS3ExternalLinkRequest, callback: (err: CppError | null, result: CppManagementAnalyticsLinkCreateResponse) => void): void;
...
export type CppObservableRequests = CppPrependRequest | CppPrependWithLegacyDurabilityRequest | CppExistsRequest | CppHttpNoopRequest | CppUnlockRequest | CppGetAllReplicasRequest | CppUpsertRequest | CppUpsertWithLegacyDurabilityRequest | CppGetAnyReplicaRequest | CppAppendRequest | CppAppendWithLegacyDurabilityRequest | CppQueryRequest | CppReplaceRequest | CppReplaceWithLegacyDurabilityRequest | CppGetAndTouchRequest | CppRemoveRequest | CppRemoveWithLegacyDurabilityRequest | CppGetRequest | CppLookupInAllReplicasRequest | CppAnalyticsRequest | CppGetProjectedRequest | CppDecrementRequest | CppDecrementWithLegacyDurabilityRequest | CppSearchRequest | CppTouchRequest | CppLookupInRequest | CppDocumentViewRequest | CppGetAndLockRequest | CppInsertRequest | CppInsertWithLegacyDurabilityRequest | CppLookupInAnyReplicaRequest | CppMutateInRequest | CppMutateInWithLegacyDurabilityRequest | CppIncrementRequest | CppIncrementWithLegacyDurabilityRequest | CppManagementGroupUpsertRequest | CppManagementEventingPauseFunctionRequest | CppManagementQueryIndexGetAllRequest | CppManagementCollectionCreateRequest | CppManagementEventingResumeFunctionRequest | CppManagementSearchIndexGetStatsRequest | CppManagementBucketGetAllRequest | CppManagementQueryIndexBuildDeferredRequest | CppManagementClusterDescribeRequest | CppManagementSearchIndexGetAllRequest | CppManagementSearchIndexAnalyzeDocumentRequest | CppManagementQueryIndexDropRequest | CppManagementAnalyticsDatasetCreateRequest | CppManagementBucketFlushRequest | CppManagementAnalyticsIndexDropRequest | CppManagementQueryIndexCreateRequest | CppManagementSearchIndexUpsertRequest | CppManagementAnalyticsDatasetGetAllRequest | CppManagementAnalyticsIndexGetAllRequest | CppManagementAnalyticsGetPendingMutationsRequest | CppManagementAnalyticsDataverseDropRequest | CppManagementAnalyticsLinkConnectRequest | CppManagementCollectionsManifestGetRequest | CppManagementChangePasswordRequest | CppManagementClusterDeveloperPreviewEnableRequest | CppManagementAnalyticsLinkDropRequest | CppManagementCollectionUpdateRequest | CppManagementBucketDescribeRequest | CppManagementEventingUpsertFunctionRequest | CppManagementViewIndexGetAllRequest | CppManagementBucketGetRequest | CppManagementBucketUpdateRequest | CppManagementBucketDropRequest | CppManagementFreeformRequest | CppManagementScopeDropRequest | CppManagementViewIndexUpsertRequest | CppManagementUserGetAllRequest | CppManagementScopeCreateRequest | CppManagementEventingGetFunctionRequest | CppManagementViewIndexDropRequest | CppManagementAnalyticsLinkReplaceAzureBlobExternalLinkRequest | CppManagementAnalyticsLinkReplaceCouchbaseRemoteLinkRequest | CppManagementAnalyticsLinkReplaceS3ExternalLinkRequest | CppManagementAnalyticsLinkDisconnectRequest | CppManagementUserUpsertRequest | CppManagementEventingGetStatusRequest | CppManagementEventingGetAllFunctionsRequest | CppManagementAnalyticsIndexCreateRequest | CppManagementScopeGetAllRequest | CppManagementUserGetRequest | CppManagementSearchIndexDropRequest | CppManagementSearchIndexControlPlanFreezeRequest | CppManagementSearchGetStatsRequest | CppManagementUserDropRequest | CppManagementAnalyticsDataverseCreateRequest | CppManagementSearchIndexControlQueryRequest | CppManagementRoleGetAllRequest | CppManagementGroupGetAllRequest | CppManagementAnalyticsLinkCreateAzureBlobExternalLinkRequest | CppManagementAnalyticsLinkCreateCouchbaseRemoteLinkRequest | CppManagementAnalyticsLinkCreateS3ExternalLinkRequest | CppManagementEventingDropFunctionRequest | CppManagementCollectionDropRequest | CppManagementSearchIndexControlIngestRequest | CppManagementEventingDeployFunctionRequest | CppManagementGroupGetRequest | CppManagementViewIndexGetRequest | CppManagementBucketCreateRequest | CppManagementAnalyticsDatasetDropRequest | CppManagementGroupDropRequest | CppManagementSearchIndexGetRequest | CppManagementQueryIndexGetAllDeferredRequest | CppManagementQueryIndexBuildRequest | CppManagementEventingUndeployFunctionRequest | CppManagementSearchIndexGetDocumentsCountRequest | CppManagementAnalyticsLinkGetAllRequest;
...
export interface CppConnection extends CppConnectionAutogen {
    connect(connStr: string, credentials: CppClusterCredentials, dnsOptions: CppDnsConfig | null, appTelemetryOptions: CppAppTelemetryConfig | null, enableTracing: boolean, orphanReporterOptions: CppOrphanReporterConfig | null, callback: (err: CppError | null) => void): void;
...
export interface CppTransaction {
    ...
    getReplicaFromPreferredServerGroup(options: {
        id: CppDocumentId;
    }, callback: (err: CppError | null, result: CppTransactionGetResult | null) => void): void;
    getMulti(options: {
        ids: CppDocumentId[];
        mode?: CppTransactionsTransactionGetMultiMode;
    }, callback: (err: CppError | null, result: CppTransactionGetMultiResult | null) => void): void;
    getMultiReplicasFromPreferredServerGroup(options: {
        ids: CppDocumentId[];
        mode?: CppTransactionsTransactionGetMultiReplicasFromPreferredServerGroupMode;
    }, callback: (err: CppError | null, result: CppTransactionGetMultiReplicasFromPreferredServerGroupResult | null) => void): void;
    insert(options: {
        id: CppDocumentId;
        content: CppEncodedValue;
    }, callback: (err: CppError | null, result: CppTransactionGetResult | null) => void): void;
