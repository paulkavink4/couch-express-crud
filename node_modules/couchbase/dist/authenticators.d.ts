 ...
 * Uncommitted: This API is subject to change in the future.
 */
export declare class JwtAuthenticator implements IJwtAuthenticator {
    /**
 ...
 * @category Authentication
 */
export type Authenticator = IPasswordAuthenticator | ICertificateAuthenticator | IJwtAuthenticator;
